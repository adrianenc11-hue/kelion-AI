...
(function () {
    ...
    class KWorkspacePanel {
        ...
        async showCurrentLocation() {
            ...
            // Use cached position and longer timeout
            const options = {
            ...
            navigator.geolocation.getCurrentPosition(
                (pos) => {
                    ...
                    this.showLocation(pos.coords.latitude, pos.coords.longitude, 'Your Location');
                },
                async (err) => {
                    ...
                    try {
                        ...
                        if (data.latitude && data.longitude) {
                            this.showLocation(data.latitude, data.longitude, data.city || 'Your Location');
                        } else {
                            this.updateStatus('Location error: ' + err.message);
                        }
                    } catch (e) {
                        this.updateStatus('Location error: ' + err.message);
                    }
