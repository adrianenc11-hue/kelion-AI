...
//          moonshot.ai, elevenlabs.io/pricing
const API_COSTS = {
    ...
    'moonshot-v1-8k': { input: 0.60, output: 3.00, unit: '1M tokens' },  // Kimi K2.5 (moonshot.ai)
    ...
    'elevenlabs': { input: 0.24, output: 0, unit: 'per 1K chars' }, // ElevenLabs Pro (elevenlabs.io)
};
